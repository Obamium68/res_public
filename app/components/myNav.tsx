export default function MyNav() {
  return (
    <div className="bg-gray-100 font-sans h-fit w-full m-0">
      <div className="container mx-auto px-4 py-2">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="sm:flex sm:items-center">
            <a
              href="/elections"
              className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4"
            >
              Election manager
            </a>
            <a
          ...
          <div className="hidden sm:flex sm:items-center">
            ...
            <a
              href="/auth/sign-up"
              className="text-gray-800 text-md font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600"
            >
              Sign up
            </a>
          </div>
        ...
        <div className="block sm:hidden bg-white border-t-2 py-2">
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-center border-t-2 pt-2">
              ...
              <a
                href="/auth/sign-up"
                className="text-gray-800 text-md font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600"
              >
                Sign up
              </a>
            </div>
